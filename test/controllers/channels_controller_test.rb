...
class ChannelsControllerTest < ActionController::TestCase
  ...
  test "should create channel" do
    assert_difference('Channel.count') do
      post :create, channel: { message_id: @channel.message_id, topic: @channel.topic, user_id: @channel.user_id }
    end
  ...
  test "should update channel" do
    patch :update, id: @channel, channel: { message_id: @channel.message_id, topic: @channel.topic, user_id: @channel.user_id }
    assert_redirected_to channel_path(assigns(:channel))
  end
